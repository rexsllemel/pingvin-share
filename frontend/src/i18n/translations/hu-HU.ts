export default {
  ...
  "home.bullet.a.description": "A Storify megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A Storify megosztáskezelőre mutató hivatkozás",
