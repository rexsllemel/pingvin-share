export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το Storify στο δικό σας μηχάνημα.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το Storify είναι διαθέσιμο",
